        ...
        <Row gap={0} justify="left" align="left">
          ...
          <Col>
            <Row justify="center" align="center">
              <img src="n2dlotto2.png" width="320px" height="100px" />
            </Row>
            <Spacer />
            <Row justify="center" align="center">
              <Text
            ...
            <Grid.Container gap={2} justify="center">
              <Grid>
                ...
                <Row>
                  ...
                  <Text
                    color="white"
                    css={{ fontFamily: "SF Pro Display", fontSize: "18px" }}
                  >
                    Seconds
                  </Text>
                </Row>
            ...
            <Row justify="center" align="center">
              ...
              <div>
                ...
                >
                    ...
                    <Grid.Container gap={2}>
                      <Grid>
                        <Button
                          ...
                          onPress={(e) => addDigits(e.target.value)}
                          auto
                        >
                          1
                        </Button>
                  ...
                  <Modal.Footer>
                    <Text h4 css={{ fontFamily: "SF Pro Display" }}>
                      cost 10
                      <img
                        src="n2dr.png"
                        style={{ marginLeft: "3px" }}
              ...
              <Row>
                <section className="stage">
                  <figure className="ball">
                    <span className="number">{win1}</span>
                  </figure>
                </section>
                <section className="stage">
                  <figure className="ball">
                    <span className="number">{win2}</span>
                  </figure>
                </section>
                <section className="stage">
                  <figure className="ball">
                    <span className="number">{win3}</span>
                  </figure>
                </section>
                <section className="stage">
                  <figure className="ball">
                    <span className="number">{win4}</span>
                  </figure>
                </section>
                <section className="stage">
                  <figure className="ball">
                    <span className="number">{win5}</span>
                  </figure>
                </section>
                <section className="stage">
                  <figure className="ball">
                    <span className="number">{win6}</span>
                  </figure>
                </section>
              </Row>
            </div>
          ...
          return (
            ...
            >
              <Card.Header css={{ display: "flex", justifyContent: "center" }}>
                ...
                <Text
                  h3
                  css={{ color: "white", marginTop: "$4", marginLeft: "$2" }}
                >
                  Draw # {draw.lottoid}
                </Text>
              </Card.Header>
              <Grid.Container css={{ pt: "$0" }}>
                <Row>
                  <Grid xs={22}>
                    <section className="stage">
                      <figure className="ball">
                        <span className="number">{draw.winningNum[0]}</span>
                      </figure>
                    </section>
                  </Grid>
                  <Grid xs={22}>
                    <section className="stage">
                      <figure className="ball">
                        <span className="number">{draw.winningNum[1]}</span>
                      </figure>
                    </section>
                  </Grid>
                  <Grid xs={22}>
                    <section className="stage">
                      <figure className="ball">
                        <span className="number">{draw.winningNum[2]}</span>
                      </figure>
                    </section>
                  </Grid>
                  <Grid xs={22}>
                    <section className="stage">
                      <figure className="ball">
                        <span className="number">{draw.winningNum[3]}</span>
                      </figure>
                    </section>
                  </Grid>
                  <Grid xs={22}>
                    <section className="stage">
                      <figure className="ball">
                        <span className="number">{draw.winningNum[4]}</span>
                      </figure>
                    </section>
                  </Grid>
                  <Grid xs={22}>
                    <section className="stage">
                      <figure className="ball">
                        <span className="number">{draw.winningNum[5]}</span>
                      </figure>
                    </section>
                  </Grid>
                </Row>
